...
const CartPage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 pb-32">
      ...
      {cartItems.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 text-text/50 space-y-4 border border-border rounded-lg">
        ...
        <div className="space-y-4">
            ...
            return (
              <div key={`${item.product.id}-${idx}`} className="flex gap-4 bg-cards p-4 rounded-lg border border-border">
                {img ? (
                  ...
                  <div className="w-24 h-32 bg-cards brightness-150 rounded flex items-center justify-center"><ShoppingBag size={20} className="text-muted" /></div>
                )}
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  <div className="text-sm text-text/60 mt-1 space-y-1">
                  ...
                  <div className="mt-auto flex justify-between items-end">
                    ...
                    <div className="flex items-center gap-3 bg-bg rounded px-3 py-1.5 border border-border">
          ...
          <div className="fixed md:static bottom-[4.5rem] md:bottom-auto left-0 w-full md:w-auto p-4 md:p-6 bg-bg md:bg-cards border-t md:border border-border md:rounded-lg mt-8 z-30">
            <div className="flex justify-between items-center mb-4">
              <span className="text-text/80 text-lg">Sous-total</span>
